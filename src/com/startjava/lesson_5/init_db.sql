--Вставка данных в таблицу Jaegers
...
VALUES ('Cherno Alpha',    'Mark-1', 85, 2412, 'Destroyed', 'Russia',                   '2015-01-01', 6), 
       ...
       ('Crimson Typhoon', 'Mark-2', 76, 1722, 'Destroyed', 'China',                    '2018-08-22', 7), 
       ('Gipsy Avenger',   'Mark-6', 81, 2004, 'Active',    'Australia',                '2034-01-12', 11), 
       ('Valor Omega',     'Mark-6', 99, 9999, 'Active',    'Russia',                   '2032-07-07', 7), 
       ('Gipsy Danger',    'Mark-4', 79, 1980, 'Destroyed', 'United States of America', '2017-07-10', 9);